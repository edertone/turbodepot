 ...
 */
@Configuration("TurboDepotSecurityConfiguration")
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) {
        return http
            ...
            .authorizeHttpRequests(auth -> auth
                .requestMatchers(WebUtils.AUTH_LOGIN_URL).permitAll()
                .requestMatchers(WebUtils.PUBLIC_URLS).permitAll()
                .requestMatchers(WebUtils.SWAGGER_URLS).permitAll()
            ...
            .logout(customizer -> customizer
                .logoutUrl(WebUtils.AUTH_LOGOUT_URL)
