...
public class ApiCheckTokenFilter extends OncePerRequestFilter {
    ...
    private final RequestMatcher requestMatcher = pathPattern(WebUtils.AUTH_CHECK_URL);
     ...
     * {@link com.edertone.turbodepot_spring.model.dto.AuthResponseDto} object. If there is no such authentication, or
